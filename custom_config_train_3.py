...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=dict(
            ...
            # class_weight=[0.1728, 0.2964, 6.3734, 1.0727, 134.3023, 5573.5469, 185.7849, 6.4064, 655.7114, 
            # 857.4688, 11147.0938, 28.7296, 655.7114, 0.5146, 0.5167, 58.6689, 15.125, 1.0736, 11147.0938, 0.4181, 0.1446, 0.7899, 
            # 0.5379, 2786.7734, 557.3547, 359.5837, 11147.0938, 14.0392, 0.5675, 11.1583, 11147.0938, 0.437]
            )),
    auxiliary_head=dict(
        type='FCNHead',
        in_channels=512,
...
work_dir = '/data/result/36-3/test0927_3/'
seed = 42
gpu_ids = range(0, 1)
device = 'cuda'
